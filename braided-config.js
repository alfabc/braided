...
module.exports = {
  ...
  agents: [
    ...
    //   watches: {
    //     ropsten: { strand: 3, blocks: 0, seconds: 604800, special: 500000 } } },
    //     goerli: { strand: 5, blocks: 0, seconds: 604800, special: 500000 } } },
    ...
    { braid: 'ropsten',
      ...
      watches: {
        ...
        kovan: { strand: 42, blocks: 231, seconds: 450, special: 5000 },
        goerli: { strand: 5, blocks: 73, seconds: 600, special: 2000 } } },
    ...
    { braid: 'rinkeby',
      ...
      watches: {
        ...
        kovan: { strand: 42, blocks: 87, seconds: 225, special: 1000 },
        goerli: { strand: 5, blocks: 43, seconds: 250, special: 1000 } } },
    ...
    { braid: 'goerli',
      ...
      watches: {
        mainnet: { strand: 1, blocks: 31, seconds: 300, special: 1000 },
        ropsten: { strand: 3, blocks: 41, seconds: 120, special: 1000 },
        rinkeby: { strand: 4, blocks: 51, seconds: 120, special: 1000 },
        kovan: { strand: 42, blocks: 61, seconds: 45, special: 1000 } } },
    ...
    { braid: 'kovan',
      ...
      watches: {
        ...
        ropsten: { strand: 3, blocks: 57, seconds: 200, special: 1000 },
        rinkeby: { strand: 4, blocks: 67, seconds: 225, special: 1000 },
        goerli: { strand: 5, blocks: 77, seconds: 120, special: 1000 } } }
  ]
}
