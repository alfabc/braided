  ...
  agents: [
    ...
    { braid: 'ropsten',
      ...
      watches: {
        ...
        rinkeby: { strand: 4, blocks: 20, seconds: 120 },
        kovan: { strand: 42, blocks: 20, seconds: 120 } } },
    ...
    { braid: 'rinkeby',
      ...
      watches: {
        ...
        ropsten: { strand: 3, blocks: 2, seconds: 20 },
    ...
    { braid: 'kovan',
      ...
      watches: {
        ...
        ropsten: { strand: 3, blocks: 1, seconds: 10 },
        rinkeby: { strand: 4, blocks: 2, seconds: 15 } } }
  ]
}
